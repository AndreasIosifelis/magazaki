...
define("CART", "Καλάθι");
define("MY_ACCOUNT", "Ο λογαριασμός μου");
define("TERMS", "Όροι χρήσης");
define("PROFILE", "Προφίλ");
define("PRODUCTS", "Προϊόντα");
define("LOGIN", "Σύνδεση");
define("USERNAME", "Όνομα χρήστη");
define("PASSWORD", "Κωδικός πρόσβασης");
define("CREATE_ACCOUNT", "Δημιουργία λογαριασμού");
